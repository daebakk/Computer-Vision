...
def main():
    src = cv2.imread('../resources/image/zebra.png')
    harris_img = src.copy()
    ...
    cv2.imshow('201804222 my interest points', interest_points)
    cv2.imwrite("../resources/image/my_interest_points.png", interest_points)
    cv2.imshow('201804222 my harris_img', harris_img)
    cv2.imwrite("../resources/image/my_harris_img.png", harris_img)
    cv2.waitKey()
